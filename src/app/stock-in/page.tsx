...
function AddonStockInPanel({
  ...
  return (
    <div style={{ background: "white", border: "1px solid var(--border)", borderRadius: "12px", padding: "20px" }}>
      <div style={{ fontSize: "14px", fontWeight: 700, marginBottom: "14px" }}>{title} 단독 입고</div>
        ...
        {options.map(o => (
          <button
            ...
            style={{
              ...
              border: "1px solid",
              borderColor: selected === o.value && !customVal ? "var(--primary)" : "var(--border)",
              background: selected === o.value && !customVal ? "#eef2ff" : "white",
              color: selected === o.value && !customVal ? "var(--primary)" : "var(--foreground)",
      ...
      {/* 선택된 값 표시 */}
      {value && (
        <div style={{ fontSize: "12px", color: "var(--primary)", marginBottom: "10px", fontWeight: 600 }}>
          등록 대상: {value}
        </div>
      )}
      ...
      {/* 합계 */}
      {unitPrice > 0 && (
        <div style={{ fontSize: "12px", color: "var(--primary)", fontWeight: 700, marginBottom: "8px", textAlign: "right" }}>
    ...
    <div>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "20px", alignItems: "start" }}>
        ...
        <div style={{ background: "white", border: "1px solid var(--border)", borderRadius: "12px", padding: "28px" }}>
          <div style={{ fontSize: "14px", fontWeight: 700, marginBottom: "16px", color: "var(--foreground)" }}>모델 입고</div>
          ...
          {unitPrice > 0 && (
            <div style={{ background: "#f8fafc", border: "1px solid var(--border)", borderRadius: "8px", padding: "10px 14px", marginBottom: "16px", display: "flex", justifyContent: "space-between" }}>
              ...
              <span style={{ fontSize: "16px", fontWeight: 700, color: "var(--primary)" }}>₩{fmt(qty * unitPrice)}</span>
            </div>
          )}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
          <AddonStockInPanel title="추가모듈" categoryName="추가모듈" options={addonOptions} />
          <AddonStockInPanel title="세부사양" categoryName="세부사양" options={specOptions} />
        </div>
      </div>
    </div>
  );
